...
## Status: Comprehensive Review with Fourth Family Integration

---

## EXECUTIVE SUMMARY: WHY DOUG SKORY MATTERS
...
2. **Second Documented Ukrainian Migration Branch**: Doug validates that Poland → Ukraine → USA migration is a repeating pattern:
   ...
   - **Skory: Poland → Ukraine (Eastern Ukraine) → USA** ← NEW (H3.4)
   - Together with potential Radzimowski collateral lines, these support H3.5 (Three Parallel Ukraine Migration Branches) as a systematic pattern.

3. **Ellis Island Immigration Bridge**: Doug's family emigration records (~1900-1920) provide access to **American genealogical archives** (Ellis Island, naturalization records, census data), which are often better digitized and more accessible than Eastern European archives.

4. **Potential Sviatopolk I Royal Connection**: As of November 2022, you noted that "Doug, Aleksei, you and I might be potentially related to Sviatopolk I of Kiev." This is worth revisiting if Big Y-700 was completed.

5. **Y-STR Data Already Collected**: Doug's Y111 profile exists at FTDNA; adding Big Y-700 gives you a fifth complete SNP dataset (after the four core comparators: Andrzej, Artur, Aleksei, Wladyslaw) for phylogenetic refinement.

---

## DOUG SKORY: BIOGRAPHICAL & GENETIC SUMMARY
...
| **FTDNA Project** | Z63 (I-Y45113 cluster per Aleksei) |
| **Big Y-700 Status** | **CRITICAL: Unknown if completed** (funded Feb 2022, $239) |

---

## KEY QUESTION: DID DOUG COMPLETE BIG Y-700?

**Background Timeline:**
- **August 20, 2021**: You and Aleksei contact Doug; he is Doug's nearest Y-DNA cousin at FTDNA.
- **September 28, 2021**: Libby Tomlinson offers to fund YSEQ test ($18); Aleksei/You offer Big Y-700 ($239).
- **February 5, 2022**: Aleksei proposes three payment options for Big Y-700 upgrade.
- **February 5, 2022**: Doug agrees: "if you could cover the cost of the bigger test BigY test we can move forward."
- **February 7, 2022**: Libby offers PayPal/Venmo; you suggest opening PayPal account.
- **February 8, 2022**: You confirm willingness to pay via PayPal.
...
## UPDATED HYPOTHESIS FRAMEWORK: WITH SKORY INTEGRATION
...
- **Confidence**: 95%
- **Priority**: 🔴 URGENT
- **Hypothesis**: Casimir Skory (Poland-born) served as pastor at St. Adalbert’s Church, with records referencing Louis Skory at the church address, anchoring the Skory line in Grand Rapids parish records.
- **Note**: Local history (History Grand Rapids photo essay by Maciej Adamski & Diana Barrett, Nov 23, 2010) states arrival in 1894 and death in March 1935; user-provided death certificate indicates 1884 birth and a 1925 death date. Reconcile identity and dates.

**H0.3: Fr. Casimir Skory Family Link to Doug’s Skory Line**
- **Status**: Pending Verification
- **Confidence**: 55%
- **Priority**: 🔴 URGENT
- **Hypothesis**: Fr. Casimir Skory is a close relative (brother/cousin/uncle) of Anthony/Casimer Skory in Doug’s lineage, providing a documentary bridge from Trzemeszno to Grand Rapids.
...
- **Priority**: 🟡 HIGH
- **Hypothesis**: All three Ukrainian representatives (Berezhnoy, Skory, and potentially Radzimowski collateral lines) followed similar 19th-century migration patterns driven by Polish uprisings, agricultural colonization, and economic opportunity.
...
## EMAIL TEMPLATE FOR JUDITH/DOUG

**Subject:** Y-DNA Big Y-700 Status Check - Family Genealogy Project Update

Dear Judith and Doug,

I hope this message finds you well. It has been over three years since we discussed your Big Y-700 upgrade at FTDNA (funded Feb 2022, $239). I wanted to follow up to confirm the status and next steps.

Over the past few years, Aleksei Berezhnoy and I have been investigating a fascinating genealogical connection across five families:
- Radzimowski (Poland, Masovia)
- Garboś (Poland, Podkarpackie)
- Mazgaj (Poland, Podkarpackie)
- Berezhnoy (Ukraine → Germany/Russia)
...
**Can you confirm:**
1. Was the Big Y-700 test completed in 2022?
2. If yes, can you share your FTDNA kit number so I can access your results?
3. If no, would you still be interested? I'm happy to resubmit full funding.
...
Andrzej Zak
andrew.peter.zak@gmail.com

---

## KEY METRICS: UPDATED WITH SKORY
...
## FINAL NOTE: WHY DOUG SKORY IS TRANSFORMATIVE
...
3. **Opens American archives**: US genealogical records (Ellis Island, naturalization, Census) are often better preserved and more accessible than Polish/Ukrainian records.

4. **Extends global reach**: You now have representatives in Poland, Ukraine, Russia, Germany, **and USA**—a true diaspora pattern for the I-Y45113 lineage.

**Bottom line**: Get Doug's Big Y-700 results. It will change everything.
